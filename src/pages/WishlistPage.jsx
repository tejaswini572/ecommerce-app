...
const WishlistPage = () => {
  ...
  return (
    <div className="min-h-screen bg-yellow-100 p-8 dark:bg-gray-900">
      <h1 className="text-3xl font-bold text-center mb-6 dark:text-white">My Wishlist ❤️</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {wishlist.map(item => (
          <div key={item.id} className="bg-white rounded-lg shadow-md p-4 dark:bg-gray-800 dark:text-white">
